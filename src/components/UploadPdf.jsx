  ...
  return (
    <div className='flex justify-center'>
      <form className='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md space-y-3'>
        <label className='block text-gray-700 text-sm font-bold' htmlFor='template'>
          Formulario:
        ...
        <div className='flex flex-col md:flex-row md:justify-around text-center space-y-2 md:space-y-0'>
          <div>
            <button className={`bg-pink-500 text-white font-bold py-2 px-4 rounded ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-pink-700'}`} type='button' disabled={disabled}>Descargar</button>
          </div>
          <div>
